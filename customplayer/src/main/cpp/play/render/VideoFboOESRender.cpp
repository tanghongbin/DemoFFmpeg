...
void VideoFboOESRender::createPbo() {
...
void VideoFboOESRender::createFbo() {
    if (fboId != 0) return;
...
void VideoFboOESRender::readImagePixel() {
...
void VideoFboOESRender::UpdateOESMartix(float *pDouble){
    oesMatrix = pDouble;
    LOGCATE("texture in native has been updated");
}
...
void VideoFboOESRender::drawLogo(GLuint currentVaoId) {
...
void VideoFboOESRender::copyImage(NativeOpenGLImage *srcImage){
...
void VideoFboOESRender::readImagePixelByPbo() {
