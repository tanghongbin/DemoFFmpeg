...
void FFmpegVideoToRgbConverter::Init(AVCodecContext* codeCtx){
...
void FFmpegVideoToRgbConverter::Destroy(){
...
void FFmpegVideoToRgbConverter::covertData(DataConvertInfo * data){
...
//                        videoHeight, targetFrame->data, targetFrame->linesize);
    AVFrame *srcFrame = data->frameData;
...
void FFmpegVideoToRgbConverter::drawVideoFrame(){
