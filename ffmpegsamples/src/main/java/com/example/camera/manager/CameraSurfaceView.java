...
public class CameraSurfaceView extends FrameLayout implements CameraSurfaceListener, Camera.PreviewCallback, SurfaceHolder.Callback {
    ...
    private SurfaceHolder.Callback mHolderCall;
    ...
    public void setmHolderCall(SurfaceHolder.Callback mHolderCall) {
        this.mHolderCall = mHolderCall;
    }
    ...
    private void init(Context context) {
        ...
        mCameraUtil.setCurrentActivity((Activity) context);
...
//        Log.d("TAG", "onPreviewFrame: " + data.length +"listener:"+listener);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (mHolderCall != null) mHolderCall.surfaceCreated(holder);
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        if (mHolderCall != null) mHolderCall.surfaceDestroyed(holder);
    }
