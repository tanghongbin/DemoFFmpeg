...
//    const char * filePath2 = "/storage/emulated/0/ffmpegtest/filterImg/test2.png";
    ...
    imageData = stbi_load(filePath, &imageInfo.width, &imageInfo.height, &imageInfo.channels, 0);
...
//            (GetSysCurrentTime() - startTime));
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, imageInfo.getFormat(), imageInfo.width,imageInfo.height, 0, imageInfo.getFormat(), GL_UNSIGNED_BYTE, imageData);
